...
* If you would prefer to build the plugin from source, then you can clone this respository, and follow the [Developer Guide](#developer-guide) below.

<!-- ## Unity Settings

The libraries are exported into the [`VologramsPlayer`](./VologramsPlayer/Runtime/Plugins/) folder. 

The `VologramsPlayer` folder can be imported directly into Unity3D from GitHub url: `https://github.com/Volograms/volograms_unity_plugin.git?path=/VologramsPlayer`.  -->
...
### FFmpeg
The Volograms Unity SDK uses builds of [FFmpeg](https://www.ffmpeg.org/).
 * For Windows and Linux, you can use pre-built builds from the [FFmpeg-Builds](https://github.com/BtbN/FFmpeg-Builds/releases) repository.
 * For Android, you can use [ffmpeg-android-maker](https://github.com/Javernaut/ffmpeg-android-maker) tool to build FFmpeg for Android.
